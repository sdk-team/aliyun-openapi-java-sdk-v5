...
import com.aliyuncs.v5.ecs.transform.v20160314.InnerQueryEcsBySerialNumberResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerQueryEcsBySerialNumberResponse extends AcsResponse {
	...
	public EcsInstance getEcsInstance() {
		return this.ecsInstance;
	}

	public void setEcsInstance(EcsInstance ecsInstance) {
	...
	public static class EcsInstance {
		...
		public static class Region {
			...
			public static class Attributes {
				...
				public String getSupportImageCopy() {
					return this.supportImageCopy;
				}

				public void setSupportImageCopy(String supportImageCopy) {
					this.supportImageCopy = supportImageCopy;
				}
	...
	@Override
	public InnerQueryEcsBySerialNumberResponse getInstance(UnmarshallerContext context) {
		return	InnerQueryEcsBySerialNumberResponseUnmarshaller.unmarshall(this, context);
	}
}
