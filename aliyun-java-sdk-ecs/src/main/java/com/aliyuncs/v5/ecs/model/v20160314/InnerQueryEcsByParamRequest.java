 ...
 * @version 
 */
public class InnerQueryEcsByParamRequest extends RpcAcsRequest<InnerQueryEcsByParamResponse> {
	...
	public InnerQueryEcsByParamRequest() {
		super("Ecs", "2016-03-14", "InnerQueryEcsByParam", "ecs");
	...
	@Override
	public Class<InnerQueryEcsByParamResponse> getResponseClass() {
		return InnerQueryEcsByParamResponse.class;
	}
