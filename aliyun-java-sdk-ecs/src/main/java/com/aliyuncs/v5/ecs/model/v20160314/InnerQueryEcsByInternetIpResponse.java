...
import com.aliyuncs.v5.ecs.transform.v20160314.InnerQueryEcsByInternetIpResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerQueryEcsByInternetIpResponse extends AcsResponse {
	...
	@Override
	public InnerQueryEcsByInternetIpResponse getInstance(UnmarshallerContext context) {
		return	InnerQueryEcsByInternetIpResponseUnmarshaller.unmarshall(this, context);
	}
}
