 ...
 * @version 
 */
public class DescribeCapacityReservationRequest extends RpcAcsRequest<DescribeCapacityReservationResponse> {
	...
	public DescribeCapacityReservationRequest() {
		super("Ecs", "2016-03-14", "DescribeCapacityReservation", "ecs");
	...
	@Override
	public Class<DescribeCapacityReservationResponse> getResponseClass() {
		return DescribeCapacityReservationResponse.class;
	}
