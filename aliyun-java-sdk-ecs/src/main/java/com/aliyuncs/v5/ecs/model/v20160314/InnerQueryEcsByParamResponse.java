...
import com.aliyuncs.v5.ecs.transform.v20160314.InnerQueryEcsByParamResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerQueryEcsByParamResponse extends AcsResponse {
	...
	@Override
	public InnerQueryEcsByParamResponse getInstance(UnmarshallerContext context) {
		return	InnerQueryEcsByParamResponseUnmarshaller.unmarshall(this, context);
	}
}
