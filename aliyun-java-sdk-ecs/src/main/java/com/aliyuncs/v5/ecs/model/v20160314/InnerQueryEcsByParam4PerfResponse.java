...
import com.aliyuncs.v5.ecs.transform.v20160314.InnerQueryEcsByParam4PerfResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerQueryEcsByParam4PerfResponse extends AcsResponse {
	...
	@Override
	public InnerQueryEcsByParam4PerfResponse getInstance(UnmarshallerContext context) {
		return	InnerQueryEcsByParam4PerfResponseUnmarshaller.unmarshall(this, context);
	}
}
