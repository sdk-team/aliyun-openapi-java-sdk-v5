...
import com.aliyuncs.v5.ecs.transform.v20160314.InnerEcsQueryByParam4PerfResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerEcsQueryByParam4PerfResponse extends AcsResponse {
	...
	@Override
	public InnerEcsQueryByParam4PerfResponse getInstance(UnmarshallerContext context) {
		return	InnerEcsQueryByParam4PerfResponseUnmarshaller.unmarshall(this, context);
	}
}
