...
import com.aliyuncs.v5.ecs.transform.v20160314.InnerQueryInstanceByParamResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerQueryInstanceByParamResponse extends AcsResponse {
	...
	private List<InstanceAsyncModel> instanceAsyncModels;
	...
	public List<InstanceAsyncModel> getInstanceAsyncModels() {
		return this.instanceAsyncModels;
	}

	public void setInstanceAsyncModels(List<InstanceAsyncModel> instanceAsyncModels) {
		this.instanceAsyncModels = instanceAsyncModels;
	}

	public static class InstanceAsyncModel {
	...
	@Override
	public InnerQueryInstanceByParamResponse getInstance(UnmarshallerContext context) {
		return	InnerQueryInstanceByParamResponseUnmarshaller.unmarshall(this, context);
	}
}
