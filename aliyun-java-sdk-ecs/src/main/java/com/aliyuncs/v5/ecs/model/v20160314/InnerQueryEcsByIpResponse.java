...
import com.aliyuncs.v5.ecs.transform.v20160314.InnerQueryEcsByIpResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerQueryEcsByIpResponse extends AcsResponse {
	...
	@Override
	public InnerQueryEcsByIpResponse getInstance(UnmarshallerContext context) {
		return	InnerQueryEcsByIpResponseUnmarshaller.unmarshall(this, context);
	}
}
