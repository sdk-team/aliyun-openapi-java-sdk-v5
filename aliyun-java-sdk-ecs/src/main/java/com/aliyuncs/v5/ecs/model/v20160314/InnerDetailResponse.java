...
import com.aliyuncs.v5.ecs.transform.v20160314.InnerDetailResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerDetailResponse extends AcsResponse {
	...
	@Override
	public InnerDetailResponse getInstance(UnmarshallerContext context) {
		return	InnerDetailResponseUnmarshaller.unmarshall(this, context);
	}
}
