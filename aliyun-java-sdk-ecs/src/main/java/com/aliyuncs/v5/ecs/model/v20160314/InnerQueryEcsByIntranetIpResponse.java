...
import com.aliyuncs.v5.ecs.transform.v20160314.InnerQueryEcsByIntranetIpResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerQueryEcsByIntranetIpResponse extends AcsResponse {
	...
	@Override
	public InnerQueryEcsByIntranetIpResponse getInstance(UnmarshallerContext context) {
		return	InnerQueryEcsByIntranetIpResponseUnmarshaller.unmarshall(this, context);
	}
}
