...
import com.aliyuncs.v5.ecs.transform.v20160314.InnerQueryEcsByInstanceIdResponseUnmarshaller;
 ...
 * @version 
 */
public class InnerQueryEcsByInstanceIdResponse extends AcsResponse {
	...
	@Override
	public InnerQueryEcsByInstanceIdResponse getInstance(UnmarshallerContext context) {
		return	InnerQueryEcsByInstanceIdResponseUnmarshaller.unmarshall(this, context);
	}
}
