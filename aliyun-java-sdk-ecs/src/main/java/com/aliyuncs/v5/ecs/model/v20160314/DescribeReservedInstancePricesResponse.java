...
import com.aliyuncs.v5.ecs.transform.v20160314.DescribeReservedInstancePricesResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeReservedInstancePricesResponse extends AcsResponse {
	...
	@Override
	public DescribeReservedInstancePricesResponse getInstance(UnmarshallerContext context) {
		return	DescribeReservedInstancePricesResponseUnmarshaller.unmarshall(this, context);
	}
}
