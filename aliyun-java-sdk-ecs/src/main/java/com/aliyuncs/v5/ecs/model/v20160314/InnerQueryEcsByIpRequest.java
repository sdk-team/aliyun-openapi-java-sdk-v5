 ...
 * @version 
 */
public class InnerQueryEcsByIpRequest extends RpcAcsRequest<InnerQueryEcsByIpResponse> {
	...
	private String bid;
	public InnerQueryEcsByIpRequest() {
		super("Ecs", "2016-03-14", "InnerQueryEcsByIp", "ecs");
	...
	@Override
	public Class<InnerQueryEcsByIpResponse> getResponseClass() {
		return InnerQueryEcsByIpResponse.class;
	}
